...
import { addOptionalProperty, doRound, colorToRGBA } from './processShared.js'

export const processTextStyles = async (textStyles, fontReferences, outputFolder, sketchFile) => {
  let swiftUIStyles = []
  let uiKitProperties = []
