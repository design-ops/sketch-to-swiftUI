import { flattenName, prepareAssetBundleForPDF, prepareAssetBundleForSVG} from './processShared.js'
import svg from 'sketch-to-svg'
import fs from 'fs'
import pdfDoc from 'pdfkit'
import SVGtoPDF from 'svg-to-pdfkit'
import path from 'path'

export const processAssets = async (layers, filepath, outputFolder, outputAsSVG) => {
  let assets = []
