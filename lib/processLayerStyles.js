...
const processLayerStyles = (layerStyles, filepath, outputFolder, modifiers) => {
    let ret = []
...
const cornerRadius = (layerStyles, styleName, modifiers) => {
  ...
  for(const modifier of modifiers) {
    // TODO: Is this includes correct? Should it be startsWith? Currently
    // styleName starts with * but the modifier name starts with /:
    // */*/*/background
    // /*/*/*/background --radius
    if (modifier.name.includes(styleName)) {
